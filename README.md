...
| 信息项 | Details |
| :--- | :--- |
| **🌐 官网 Website** | [点击访问 Click to Visit](https://iterm2.com/) |
| **🖥 适用系统 Operating Systems** | ![macOS](https://img.shields.io/badge/macOS-000000?logo=apple&logoColor=white&style=for-the-badge)  |
| **🛠 功能用途 Features / Usage** | 终端 |
| **🔓 是否开源 Open Source** | ![Open Source](https://img.shields.io/badge/Open%20Source-Yes-brightgreen) |
| **📦 GitHub源代码 GitHub Repository** | [GitHub链接 / GitHub Link](https://github.com/gnachman/iTerm2) |
| **⭐ GitHub Stars** | ![Stars](https://img.shields.io/github/stars/gnachman/iTerm2?style=social) |
| **💰 是否免费 Cost** | ![Free](https://img.shields.io/badge/Cost-Free-brightgreen) |
| **✨ 亮点 Highlights** | - Split Panes  拆分窗格</br>- Hotkey Window  热键窗口</br>- Search  搜索</br>- Autocomplete  自动完成</br>- Copy Mode  复制模式</br>- ...|
| **🏷 分类 Tags** |#效率 / #Productivity #工具 / #Tool #开发工具 / #Development|
